                    ...
                    <div className="w-full md:w-[45%] h-full flex flex-col text-xs md:text-sm lg:text-sm">
                        ...
                        <div className="w-[80%] md:w-full h-auto flex flex-col gap-2 ml-8 mt-8">
                            ...
                            <div className="flex flex-col w-full gap-2 mt-2">
                                ECO FUNDIA 프로젝트는 제가 처음으로 Spring 기반 MSA 아키텍처를 설계하고, Kafka, Redis, MongoDB 등 다양한 기술 스택을 실무에 적용해본 의미 있는 경험이었습니다. 단순히 기능 구현에 그치지 않고, 메시지 유실 방지, API 보안 등 
                            ...
                            <div className="flex flex-col w-full gap-2 mt-2">
                                ...
                                <br/> 또한 상품 주문과 같이 정합성이 중요한 로직의 경우, 초기 구현 단계에서는 단순한 메시지 처리 방식으로 접근하였으나,이후 프로젝트를 정리하며 Kafka와 Redis Lua 스크립트를 조합해
                                메시지 순서 보장과 연산의 원자성을 확보하는 구조를 적용했더라면
                                더욱 안정적인 설계가 되었을 것이라고 회고하게 되었습니다.
